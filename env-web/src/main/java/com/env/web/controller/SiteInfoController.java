...
public class SiteInfoController {
	...
	public ResponseApi multipointHeader() throws Exception {
		...
		a.setWidth(60);h.setWidth(100);b.setWidth(200);d.setWidth(200);e.setWidth(200);
		header.add(a);header.add(h);header.add(b);header.add(d);header.add(e);header.add(c);
		api.success(header);
		return api;
	}
